...
public class MainActivity extends AppCompatActivity
    ...
    // display AddEditFragment to add a new moive
    @Override
    ...
    // display a movie
    private void displayContact(Uri movieUri, int viewID) {
    ...
    public void onMovieDeleted() {
        // removes top of back stack
        getSupportFragmentManager().popBackStack();
        moviesFragment.updateMovieList(); // refresh movie
    }
    ...
    public void onAddEditCompleted(Uri movieUri) {
        ...
        if (findViewById(R.id.fragmentContainer) == null) { // tablet
            ...
            displayContact(movieUri, R.id.rightPaneContainer);
        }
    }
}